...
def main(num_cols, num_rows, square_size_cm):
    ...
    for image_path in image_files:
        ...
        if found:
            ...
            # コーナーを描画して保存
            image_with_corners = cv2.drawChessboardCorners(image, (num_rows, num_cols), refined_corners, found)
...
if __name__ == '__main__':
    ...
    parser.add_argument('cols', type=int, help='チェッカーボードの横方向の交点の数')
    parser.add_argument('rows', type=int, help='チェッカーボードの縦方向の交点の数')
    parser.add_argument('size', type=float, help='マスの大きさ（cm）')
